  ...
  transcrevezap:
    ...
    deploy:
      labels:
        ...
        - "traefik.http.routers.transcreve_api.service=transcreve_api"
        ...
        - "traefik.http.routers.transcreve_mgr.service=transcreve_mgr"
...
deploy_via_portainer "$STACK_NAME" "transcrevezap.yaml"
