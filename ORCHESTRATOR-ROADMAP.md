...
- [ ] **E5: Skills de Infraestrutura de Dados** — Bancos, filas, busca vetorial
- [ ] **E6: Skills de Aplicação — AI/LLM** — Agentes, modelos, plataformas de IA
...
- **Fase Atual**: E5 (Skills de Infraestrutura de Dados) — Aguardando instrução
- **Estado**: Planejado
...
- [ ] T24: Skill `app-flowise`         — Flowise (orquestração LLM low-code)
- [ ] T25: Skill `app-dify`            — Dify (plataforma LLM + RAG)
- [ ] T26: Skill `app-ollama`          — Ollama (modelos locais)
- [ ] T27: Skill `app-openwebui`       — Open WebUI (frontend Ollama)
- [ ] T28: Skill `app-langfuse`        — Langfuse (observabilidade LLM)
...
- [ ] T35: Skill `app-unoapi`          — UnoAPI (gateway WhatsApp via Baileys)
- [ ] T36: Skill `app-quepasa`         — QuePasa (gateway WhatsApp)
- [ ] T37: Skill `app-wuzapi`          — WuzAPI (gateway WhatsApp)
- [ ] T38: Skill `app-wppconnect`      — WPPConnect (gateway WhatsApp)
- [ ] T39: Skill `app-transcrevezap`   — TranscreveZap (transcrição de áudio WhatsApp)
...
| E21 | 2 | ⏳ Aguardando |
| E22 | 2 | ⏳ Aguardando |
| E23 | 5 tarefas | ⏳ Aguardando |
| **Total** | **~102 skills** | **7 feitas / 95 pendentes** |
